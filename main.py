...
def get_selic_futura(ano_final):
    """
    Obtém a taxa SELIC futura aproximada a partir da API do Banco Central.
    """
    try:
        ...
        return 0.105  # valor de fallback
    ...
    with st.spinner("Calculando..."):
        try:
            ...
            st.session_state["dados"] = {
                ...
                "dividendo": dividendo,
                "anos": anos,
                "margem_segurança": margem_segurança
            }
            ...
            if capm > crescimento:
                ...
                anos = dados["anos"]
                margem_segurança = dados["margem_segurança"]
                ...
                **Como interpretar:**
                ...
                - **Dividend Yield**: simula variações na rentabilidade de dividendos em relação
